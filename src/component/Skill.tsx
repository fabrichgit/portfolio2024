    ...
    return (
        <div className="flex flex-col gap-12 w-full h-max">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mx-auto mb-16 max-w-4xl md:auto-rows-[16rem]">
                <div className="row-span-1 rounded-xl bg-card/10 group/bento transition duration-200 shadow-input dark:shadow-none p-4 justify-between flex flex-col space-y-4 [&amp;>p:text-lg] md:col-span-1 hover:bg-blue-900/50 bg-blue-900/20 hover:shadow-2xl">
                    <div className="w-full flex items-center justify-center p-2 border-2 border-blue-900/70 rounded-lg bg-blue-900/40">
                ...
                <div className="row-span-1 rounded-xl bg-card/10 group/bento transition duration-200 shadow-input dark:shadow-none p-4 justify-between flex flex-col space-y-4 [&amp;>p:text-lg] md:col-span-2 hover:bg-blue-900/50 bg-blue-900/20 hover:shadow-2xl"><div>
                    <img src="/backend.png" className="w-full h-full object-cover rounded-lg border-2 border-blue-900/70 border-[#0a283b]" />
                </div>
                    <div className="flex flex-col gap-2">
                        <SiBackendless/>
                ...
                <div className="row-span-1 rounded-xl bg-card/10 group/bento transition duration-200 shadow-input dark:shadow-none p-4 justify-between flex flex-col space-y-4 [&amp;>p:text-lg] hover:bg-blue-900/50 bg-blue-900/20 hover:shadow-2xl">
